  ...
  if (error && !title) {
    return (
      <div className="max-w-xl mx-auto px-4 py-8">
        ...
        <button onClick={() => router.push('/errands')} className="mt-4 text-sm text-orange-600 hover:underline">← 심부름 목록으로</button>
      </div>
    )
  }
    ...
    <div className="max-w-xl mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input type="number" value={reward} onChange={(e) => setReward(e.target.value)} required min={0} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-500" />
        </div>
